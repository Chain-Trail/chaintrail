...
const Referrals = () => {
  return (
    <section className="px-8 ">
      ...
      <div className="">
        <h1 className="my-4">EARN MORE POINTS</h1>
        <div className="flex  gap-4 items-center justify-center ">
          <div className="w-[173px] bg-neutral-800 h-[173px] rounded-xl">
            <img
              src="coinsPana.svg"
          ...
          <div className=" w-[173px] bg-neutral-800 h-[173px] rounded-xl">
            ...
            <button className="bg-yellow-500 hover:bg-yellow-600 text-black py-2 px-4 rounded-xl text-[12px] font-bold relative top-[-12px] right-[-50px]">
              Use Daily Pass
            </button>
          </div>
        </div>
      ...
      <div className="text-center my-12 text-2xl">
        ...
        <div className="bg-neutral-700 p-4 rounded-lg text-sm flex justify-between my-4">
          <input
      ...
      <div>
        ...
        <div className="flex items-center justify-between gap-4 rounded-lg">
          <div className=" flex flex-col items-center justify-center gap-8 w-40 h-30 p-3 rounded-xl bg-neutral-700 text-yellow-500">
